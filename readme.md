...
변경 이벤트가 발생하면 해당 binlog 상태를 기억하고, 인메모리 캐싱 데이터에 동기화 작업을 진행한다. 여기까지가 하나의 트랜잭션이다.
...
|      **1%** |             - |           - |            - |           - |            - |           - |
|     **20%** |             - |           - |            - |           - |            - |           - |
|     **40%** |   **384 TPS** | **+373.5%** |    **423ms** |  **+98.0%** |  **4,814ms** |  **+82.2%** |
|     **60%** |   **390 TPS** | **+380.9%** |    **193ms** | **+99.08%** |    **622ms** | **+97.70%** |
|    **100%** |   **391 TPS** | **+382.1%** |   **14.6ms** | **+99.93%** |  **≈190ms*** | **≈99.30%** |
...
처리대상(WRITE/READ)는 달랐지만, 성능 개선 효과는 캐싱이 확실.
...
## 참고. MySQL Replication Protocol - BinlogPosition(COM_BINLOG_DUMP)